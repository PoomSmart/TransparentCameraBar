...
- (id)init {
    if (self == [super init]) {
        ...
        UIImage *image = [UIImage imageNamed:@"Heart" inBundle:[NSBundle bundleWithPath:@"/Library/PreferenceBundles/TransparentCameraBarSettings.bundle"]];
        if (isiOS7Up)
